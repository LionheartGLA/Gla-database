...
const lastDate = "22-11-2024";

function getRotationChars(rotation) {
    return rotation.map(name => chars.find(char => char.name === name));
}

const rotationOne = getRotationChars(['Roronoa Zoro', 'Jesus Burgess', 'Basil Hawkins']);
const rotationTwo = getRotationChars(['Vinsmoke Sanji', 'Carrot', 'Vinsmoke Yonji']);
