const chars = [
    ...
    { name: "Killer", type: "gold", dates: ["09-08-2024", "21-06-2024", "03-05-2024"], image: "Img/Medals/Killer.png", class: ["Cortante", "DPS", "Supernova"] },
...
const lastDate = "13-09-2024";

function getRotationChars(rotation) {
    return chars.filter(char => rotation.includes(char.name));
}

const rotationOne = getRotationChars(['Tony Tony Chopper', 'Capone Gang Bege', 'Bellamy']);
const rotationTwo = getRotationChars(['Franky', 'Vinsmoke Reiju', 'Smoker']);