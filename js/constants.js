...
const lastDate = "11-10-2024";

function getRotationChars(rotation) {
    return rotation.map(name => chars.find(char => char.name === name));
}

const rotationOne = getRotationChars(['Bastille', 'Basil Hawkins', 'Urouge']);
const rotationTwo = getRotationChars(['Koala', 'Baby 5', 'Leo e Mansherry']);
